...
class LoginScreen extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // 화면 하단에 공간을 채우기 위해 SizedBox 대신 Spacer를 사용하려면
              // Column을 ConstrainedBox와 IntrinsicHeight로 감싸야 합니다.
              // 여기서는 간단하게 SizedBox로 고정 높이를 주었습니다.
  ...
  Widget _buildTextField(String hintText, {bool isPassword = false, TextInputType? keyboardType}) {
    return TextField(
    ...
    return const Row(
      children: [
        ...
        Padding(
          ...
          child: Text(
            'OR',
            style: TextStyle(color: Color(0xFF6A707C), fontWeight: FontWeight.w600),
          ),
        ),
        Expanded(child: Divider(color: Color(0xFFE8ECF4))),
      ],
