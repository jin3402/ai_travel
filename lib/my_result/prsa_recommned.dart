...
class TravelApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChiangMaiRecommendationScreen(),
    );
  }
}

// --- 추천 여행지 상세 화면 (치앙마이) ---
class ChiangMaiRecommendationScreen extends StatelessWidget {
  const ChiangMaiRecommendationScreen({super.key});
        ...
        Padding(
          ...
          child: Text(
            ...
            style: const TextStyle(
              color: Color(0xFFC4FFD3), // Figma 디자인의 텍스트 색상 적용
              fontSize: 50,
